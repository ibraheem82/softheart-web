"""
Django settings for softheart project.
...
SECRET_KEY = 'django-insecure-fpxj4q0b_3f+wt9ui*02*%obq6c6-ap5=()2pxld(^0td3_dp#'
...
WSGI_APPLICATION = 'softheart.wsgi.application'
